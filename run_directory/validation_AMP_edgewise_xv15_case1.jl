...
np = 7
var1a = LinRange(7.5,12.7,np)
var1b = LinRange(6.5,12,np)
var1c = LinRange(6,9,np)
var1d = LinRange(5,10.4,np)
var1e = LinRange(4.3,10,np)
var1f = LinRange(3.5,9,np)
var1g = LinRange(2.7,8.2,np)
...
data_exp = XLSX.readtable("../data_validation/xv15_data/xv15_data.xlsx","edgewise1")
