...
np = 7
var1a = LinRange(6.5,9.4,np)
var1b = LinRange(5.3,8.2,np)
var1c = LinRange(4,7,np)
var1d = LinRange(2.7,5.8,np)
var1e = LinRange(1.5,4.6,np)
var1f = LinRange(0.3,3.4,np)
var1g = LinRange(-0.9,2.2,np)
...
data_exp = XLSX.readtable("../data_validation/xv15_data/xv15_data.xlsx","edgewise4")
