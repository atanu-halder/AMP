...
var1c = LinRange(5.5,11,np)
var1d = LinRange(4.7,10.2,np)
var1e = LinRange(4,9.7,np)
var1f = LinRange(3,8.7,np)
var1g = LinRange(2,8,np)
...
data_exp = XLSX.readtable("../data_validation/xv15_data/xv15_data.xlsx","edgewise2")
