...
file = XLSX.readxlsx("../input_directory/inputs_sirohi.xlsx")
...
data_exp = XLSX.readtable("../data_validation/exp_sirohi.xlsx","Sheet1")
exp = hcat(data_exp.data...)

p1=plot(xlabel=L"\textbf{C_T/\sigma}", ylabel=L"\textbf{C_P/\sigma}",framestyle=:box)
