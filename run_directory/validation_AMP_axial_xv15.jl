...
data_exp = XLSX.readtable("../data_validation/xv15_data/xv15_data.xlsx","eta")
exp = hcat(data_exp.data...)

p1=plot(xlabel=L"\textbf{C_T/\sigma}", ylabel=L"\textbf{\eta}",framestyle=:box)
plot!(ctbysigma,eta_arr,lw=2,label=L"\textbf{AMP Axial}")
